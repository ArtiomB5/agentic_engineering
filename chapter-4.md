...
- §4.12 MCP Bloat — зеркальный анти-паттерн: слишком много MCP
- §4.13 No Browser Use — Playwright MCP решает эту проблему
- §9.3 MCP Security — ветирование перед установкой
- §11.2 Shared Rules — MCP-реестр для командного управления
