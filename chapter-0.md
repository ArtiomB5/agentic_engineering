...
### Глава 10: Командная работа и governance → контекст на уровне организации
...
Понимание этого принципа превращает список правил из глав 1–10 из набора рекомендаций в логически связанную систему.
...
Пример: Спросите сырую модель "какая погода в Москве?" — она откажется или выдумает ответ. Harness с инструментом browser_action или MCP решает эту задачу детерминированно.
