...
Контекст рабочего пространства — фундамент, на котором строится всё взаимодействие с AI-агентом. Правильно организованный контекст экономит токены, повышает точность ответов и позволяет агенту действовать как полноценный член команды. Эта глава детально разбирает файловую структуру и механизмы экосистемы Cline: от модульных правил и навыков до кастомных агентов, workflows и хуков жизненного цикла.
