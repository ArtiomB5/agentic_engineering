...
Отладка и диагностика — это то, как вы выявляете и устраняете проблемы при работе с Cline. Плохая диагностика превращает любой сбой в чёрный ящик: вы не знаете, почему агент сделал то, что сделал, и не можете воспроизвести результат. В этой главе разобраны наиболее распространённые причины отказов и конкретные инструменты, помогающие держать разработку предсказуемой, воспроизводимой и управляемой.

---

## Ключевой принцип

Большинство проблем при работе с Cline — не баги модели и не ошибки промптов. Это симптомы трёх системных причин: насыщение контекста, недетерминированность LLM или неправильная конфигурация harness. Эта глава даёт инструменты для диагностики каждой из них.
