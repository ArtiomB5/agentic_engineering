...
- **[Приложение В: Руководство по созданию воркфлоу для Cline](appendix-workflows.md)** — полное руководство: как работают воркфлоу технически, анатомия файла, правила именования, карта категорий, дерево решений, правила написания, примеры, диагностика и чеклист.
- **[Приложение Г: Руководство по созданию плагинов для Cline CLI](appendix-plugins.md)** — полное руководство по проектированию, написанию, тестированию и публикации плагинов для Cline. Охватывает оба формата — одиночный файл и пакет с зависимостями.
- **[Приложение Д: Руководство по созданию хуков для Cline](appendix-hooks.md)** — полное руководство по двум системам хуков — файловым (`.cline/hooks/`) и плагинным runtime-хукам. Охватывает технику, форматы, примеры и диагностику.
