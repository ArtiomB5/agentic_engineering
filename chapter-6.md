...
Измерение эффективности — неотъемлемая часть зрелой практики AI-разработки. Эта глава посвящена метрикам и аналитике: активность и распределение по часам, объём сгенерированного кода, потребление токенов, покрытие парсеров, оптимизация рабочего процесса, управление контекстом, баланс работы и жизни, а также состояние потока. Все эти метрики доступны прямо в интерфейсе Cline — от истории задач до OpenTelemetry-экспорта для корпоративных дашбордов.
...
| **Shallow** | Частые follow-up, переключение между задачами. Что-то идёт не так. |
