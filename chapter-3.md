...
* [3.7. Single-Workspace Tunnel Vision — Туннельное зрение](#38-single-workspace-tunnel-vision--туннельное-зрение)
* [Общий принцип категории Code Review](#общий-принцип-категории-code-review)

---

Категория Code Review охватывает самые критичные моменты при работе с AI-инструментами. Три из первых четырёх правил в этом разделе имеют критический уровень серьёзности — это не случайно. Принятие AI-кода без понимания — не ускорение разработки, а накопление долга, который придётся выплачивать позже. В этой главе мы разбираем восемь ключевых антипаттернов и предлагаем конкретные приёмы, которые превращают генерацию кода в контролируемый, осмысленный процесс.
...
1. **Всегда задавайте follow-up вопросы после получения кода:**
   ```
...
3. **Не копируйте вслепую.** Если вы не задали ни одного follow-up вопроса и не отредактировали ни одной строки — вы не поняли код. Правило «объясни коллеге»: если не можете пересказать код своими словами, вернитесь и разберитесь.
...
10. **Читайте команду перед одобрением.** Прочитайте полностью, включая все флаги и аргументы. Если команда太长 — потребуйте объяснения от агента перед выполнением.
